...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tellMeWhatYouDo("onCreate");
        licznikCreate++;
    }

    private void tellMeWhatYouDo(String info){
    ...
    public void lockUnlockEdit(View view){
